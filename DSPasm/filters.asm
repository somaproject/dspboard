...
*/
	 ...
	 f8 = 0; f4=0;  	// zero accumulator register
...
Input
	...
	coefficients are G, a2, a1, b2, b1, cycle. Because we normalize
    b0 to one, we need to worry about an arbitrary gain factor, lest
	we have scaling problems. This gain factor is the first element
	of the vector. 
Output:
	f8 : output sample
...
// take care of gain factor
f4=pm(i8, m8); // load gain 


f8 = f8 * f4,  b1 = b0; // i1 is used to update the delay line with new values, it lags behind i0;
...
lcntr = r1, do quads until lce;
	...
	// a2*w(n-2), x(n) or y(n) from previous section + 0, get w[n-1], get a1
